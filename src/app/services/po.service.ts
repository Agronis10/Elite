...
public getItemsToNewPo(type:string)
{
  
  return this.http.get('http://localhost:54530/api/po/InitDetails/' + localStorage.getItem("currentUser") +"/"  +type);
 //return this.http.get('https://www.elitedistribution.soccer/EliteAPI/api/po/InitDetails/' + localStorage.getItem("currentUser") +"/" +type);
}
}
